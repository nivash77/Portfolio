                ...
                <div className=" h-[60%] w-[25%] bg-red z-50 flex flex-col  bg-white  shadow-lg ">
                    ...
                    <div className="w-full h-[85%] flex flex-row justify-center items-center">
                        <form className="w-[80%] h-[80%] flex flex-col justify-center items-center gap-4" onSubmit={handleaddProject}>
                            ...
                            <input type="text" ref={linkr} name="" id="link" placeholder="ProjectLink"  required className="p-3 bg-[#e7e8ea] w-full font-bold outline-none active:outline-none focus:border-b-4 hover:border-gray-500 rounded-md"/>
